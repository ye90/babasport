						...
						<div class="topbg">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="420" height="38"><img
											src="/res/itcast/img/admin/welconlogin-icon.png" /><span
											id="welcome">您好:admin!</span> <img
											src="/res/itcast/img/admin/loginout-icon.png" /><a
											href="logout.do?returnUrl=index.do" target="_top" id="logout"
											onclick="return confirm('您确定退出吗?');">退出</a>  <img
											src="/res/itcast/img/admin/message-unread.png" />&nbsp;<a
							...
							<div class="nav">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td
											style="background-image: url('/res/itcast/img/admin/nav-left.png')"
											width="14" height="31"></td>
										<td>
											<ul class="nav-menu">
												<li class="current" id="tb_11" onclick="HoverLi(11);"><a
													href="main.do" target="mainFrame">首页</a></li>
												<li class="sep"></li>
												...
												<li class="normal" id="tb_21" onclick="HoverLi(21);"><a
													href="freme/deploy_main.do" target="mainFrame">部署</a></li>
											</ul>
										</td>
									</tr>
								</table>
