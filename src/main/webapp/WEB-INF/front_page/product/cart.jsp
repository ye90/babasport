...
<div class="w ofc case">
	<div class="confirm">
		...
		<div class="ofc pb40">
			...
			<div class="page">
				<span class="l">
					<%-- <input type="button" value="继续购物" title="继续购物" class="hand btn100x26c" onclick="window.open('/product/detail.shtml?id=${productId}')" /> --%>
					<input type="button" onclick="self.location=document.referrer;" class="hand btn100x26c" title="继续购物" value="继续购物">
