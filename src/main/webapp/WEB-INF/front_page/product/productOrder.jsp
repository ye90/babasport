		...
		<tbody>
			...
			<tr>
				...
				<td class="img48x20">
					...
					<a href="/product/detail.shtml?id=${item.sku.product.id }" target="block">${fn:substring(item.sku.product.name,0,30)}--${item.sku.color.name}--${item.sku.size}</a>
				</td>
		...
		<div class="ofc">
			<div class="r">
				<dl class="total">
					...
					<dd><em class="l">返现：</em>￥<var>${buyCart.fee }</var></dd>
