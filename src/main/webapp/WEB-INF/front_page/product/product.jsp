...
<div class="bar"><div class="bar_w">
	...
	<ul class="r uls">
	<li class="dev">您好,欢迎来到新巴巴运动网！</li>${buyer_session.username}
	<c:if test="${!isLogin }">
		...
		<h2 class="h2 h2_filter mt"><em title="商品筛选">商品筛选</em><cite><a href="javascript:void(0);" id="filterRest" title="重置筛选条件">重置筛选条件</a></cite></h2>
			<ul class="uls filter">
				...
				<li><b>材质：</b><p>
					...
					<span><a href="javascript:void(0);" title="${feature.name }" onclick="window.location.href='/product/display/list.shtml?typeId=${type.id }&typeName=${type.name}&brandId=${brandId }&brandName=${brandName }'">${feature.name }</a></span>
					</c:forEach>
				</p></li>
				</c:if>
				<li><b>适用人群：</b><p>
