...
public class FrontProductController {
	...
	public String list(Integer pageNo, Integer featureId, Integer brandId, String brandName, Integer typeId,
			String typeName, ModelMap model) {
		...
		// 设置每页数
		productQuery.setPageSize(Constants.FRONT_PRODUCT_PAGE_SIZE);
		// 设置Id倒排
		productQuery.orderbyId(false);
		// 显示上线的产品
		productQuery.setIsShow(Constants.YES);
		// 条件 
		// 隐藏已选条件
		boolean flag = false;
		// 条件Map窗口
